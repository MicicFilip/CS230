...
window.onload = init;
var socket = new WebSocket("ws://localhost:8080/CS230-DZ12/actions");
...
function addDevice(ime, prezime, fakultet) {
    var DeviceAction = {
        action: "add",
        ime: ime,
        prezime: prezime,
...
function printDeviceElement(device) {
    ...
    deviceName.innerHTML = device.ime + " " + device.prezime;
    deviceDiv.appendChild(deviceName);

    var deviceType = document.createElement("span");
    deviceType.innerHTML = "<b>Fakultet:</b> " + device.fakultet;
...
//    deviceDescription.innerHTML = "<b>Fakultet:</b> " + device.fakultet;
//    deviceDiv.appendChild(deviceDescription);

    var removeDevice = document.createElement("span");
    removeDevice.setAttribute("class", "removeDevice");
    removeDevice.innerHTML = "<a href=\"#\" OnClick=removeDevice(" + device.id + ")>Remove student</a>";
...
function formSubmit() {
    ...
    var ime = form.elements["device_name"].value;
    var prezime = form.elements["device_surname"].value;
    var fakultet = form.elements["device_type"].value;
    hideForm();
    document.getElementById("addDeviceForm").reset();
    addDevice(ime, prezime, fakultet);
}
