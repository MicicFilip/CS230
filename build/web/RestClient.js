...
// Model for Employees entity
    models.Employees = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/CS230-DZ13/webresources/cs230.dz13.employees/",
        idAttribute: 'empNo',
        defaults: {
            firstName: "",
            lastName: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/CS230-DZ13/webresources/cs230.dz13.employees';
            }
    ...
    models.EmployeesCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/CS230-DZ13/webresources/cs230.dz13.employees",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
    ...
    var AppRouter = Backbone.Router.extend({
            ...
            this.collection.fetch({
                success: function () {
                    self.listView = new views.ListView({
                        ...
                        // tpl-employees-list-itemis template identifier for item
        ...
        details: function (id) {
            if (this.collection) {
                ...
                this.view = new views.ModelView({
                    ...
                    // tpl-employees-details is template identifier for chosen model element
        ...
        create: function () {
            ...
            this.view = new views.ModelView({
                ...
                // tpl-employees-details is a template identifier for chosen model element
                templateName: '#tpl-employees-details',
