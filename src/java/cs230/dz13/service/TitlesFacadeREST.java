...
public class TitlesFacadeREST extends AbstractFacade<Titles> {
    ...
    private TitlesPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;empNo=empNoValue;title=titleValue;fromDate=fromDateValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        cs230.dz13.TitlesPK key = new cs230.dz13.TitlesPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        cs230.dz13.TitlesPK key = getPrimaryKey(id);
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Titles> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
